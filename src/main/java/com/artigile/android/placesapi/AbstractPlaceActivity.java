...
/**
 * @author IoaN, 11/17/12 10:04 PM
 */
public abstract class AbstractPlaceActivity extends RoboListActivity {
    ...
    public void loadMorePlaces(final PlacesSearchListener placesSearchListener){
        new AsyncTask<String, Void, String>(){
            ...
            protected String doInBackground(String... params) {
                try {
                    PlacesApiResponseEntity places = googlePlacesApi.searchNearBy(getBaseContext().getString(R.string.api_key),
                           -1, -1, null, null, true, null, null, null, null, appState.getLastSearchResult().getNextPageToken());
                    appState.setLastSearchResult(places);
